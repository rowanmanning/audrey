...
function createEntryMarkup(number, dateMod) {
	return `
		<entry>
			...
			<link rel="alternate" type="text/html" href="http://mock.feeds/002/entry-${number}"/>
			<id>http://mock.feeds/002/entry-${number}</id>
...
nock('http://mock.feeds/')
	...
	.reply(200, `
		...
		<feed xmlns="http://www.w3.org/2005/Atom">
			...
			<link href="http://mock.feeds/002/feed.xml" rel="self" />
			<link href="http://mock.feeds/002/" />
			<id>http://mock.feeds/002/</id>
